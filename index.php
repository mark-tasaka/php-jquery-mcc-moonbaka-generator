...
<html>
<head>
<title>Launch Page: Moonbaka Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
		<form action="" id ="moonbakaForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Moonbaka, Level 1</option>
				<option value="02">Moonbaka, Level 2</option>
				<option value="03">Moonbaka, Level 3</option>
				<option value="04">Moonbaka, Level 4</option>
				<option value="05">Moonbaka, Level 5</option>
				<option value="06">Moonbaka, Level 6</option>
				<option value="07">Moonbaka, Level 7</option>
				<option value="08">Moonbaka, Level 8</option>
				<option value="09">Moonbaka, Level 9</option>
				<option value="10">Moonbaka, Level 10</option>
			  </select>
        ...
        {
            $("#moonbakaForm").attr('action', "moonbaka/moonbaka"+ $("#level").val() +  ".php");
        });
