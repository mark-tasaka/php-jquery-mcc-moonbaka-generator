...
<html>
<head>
<title>Iconic NPC Moonbaka Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_moonbaka.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_moonbaka_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Moonbaka Character Constructor
	*/
	function Character() {
	...
	return shaman[3]; 
       ...
       let imgData = "images/moonbaka_character_sheet.png";
